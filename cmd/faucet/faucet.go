...
var (
	...
	suaveFlag   = flag.Bool("suave", false, "Initializes the faucet with Suave testnet network config")
)
...
func main() {
	...
	genesis, err := getGenesis(*genesisFlag, *goerliFlag, *sepoliaFlag, *suaveFlag)
	if err != nil {
...
func getGenesis(genesisFlag string, goerliFlag bool, sepoliaFlag bool, suaveFlag bool) (*core.Genesis, error) {
	switch {
	case genesisFlag != "":
	...
	case suaveFlag:
		return core.DefaultSuaveGenesisBlock(), nil
	case sepoliaFlag:
