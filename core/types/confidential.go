...
func (tx *ConfidentialComputeRecord) encode(b *bytes.Buffer) error {
	return rlp.Encode(b, tx)
}

func (tx *ConfidentialComputeRecord) decode(input []byte) error {
...
func (tx *ConfidentialComputeRequest) encode(b *bytes.Buffer) error {
	return rlp.Encode(b, tx)
}

func (tx *ConfidentialComputeRequest) decode(input []byte) error {
	return rlp.DecodeBytes(input, tx)
}
...
func (tx *SuaveTransaction) encode(b *bytes.Buffer) error {
	return rlp.Encode(b, tx)
}

func (tx *SuaveTransaction) decode(input []byte) error {
	return rlp.DecodeBytes(input, tx)
}
